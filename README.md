...
Trong **Today’s scope / Phạm vi hôm nay**, bấm vào ô số bên trái từng mục để đánh dấu hoàn thành hoặc mở lại. Nút **Mark all done / Đánh dấu tất cả** hoàn thành nhanh toàn bộ 5 mục; trạng thái được lưu riêng cho từng buổi. Timer đang chạy hoặc tạm dừng vẫn được giữ khi nhấn F5; khi mở lại trang Study, app tiếp tục đúng buổi và đúng thời gian trước đó. Khi Focus Timer đếm về 0, app phát một chuỗi âm báo ngắn và vẫn tự ghi thời gian đã tập trung. Thời gian đã lưu của từng buổi được hiển thị trong **24-week plan** và ngay trong khung timer của buổi đó.
